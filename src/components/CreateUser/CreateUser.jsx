					...
					<Grid container spacing={2} direction="row" justify="Center">
						<Grid item xs={12} sm={6}>
							<TextField
								...
								onChange={e => e.props.handleChange('firstname')}
								autoFocus
							/>
						</Grid>
						<Grid item xs={12} sm={6}>
							<TextField
								...
								onChange={e => e.props.handleChange('lastname')}
								autoFocus
							/>
						</Grid>
					</Grid>
					<Grid container spacing={2} direction="row" justify="Center">
						<Grid item xs={12} sm={6}>
							<TextField
								...
								onChange={e => e.props.handleChange('email')}
								autoFocus
							/>
						</Grid>
						<Grid item xs={12} sm={6}>
							<TextField
								...
								onChange={e => e.props.handleChange('phoneNumber')}
								autoFocus
							/>
						</Grid>
					</Grid>
					<Grid container spacing={2} direction="row" justify="Center">
						<Grid item xs={12} sm={6}>
							<TextField
								...
								onChange={e => e.props.handleChange('address')}
								autoFocus
							/>
						</Grid>
						<Grid item xs={12} sm={6}>
							<TextField
								...
								onChange={e => e.props.handleChange('education')}
								autoFocus
							/>
						</Grid>
					</Grid>
					<Grid container spacing={2} direction="row" justify="Center">
						<Grid item xs={12}>
							<TextField
								...
								onChange={e => e.props.handleChange('dateOfBirth')}
								autoFocus
							/>
						</Grid>
					</Grid>
